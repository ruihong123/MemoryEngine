...
# Analytical scan configuration (enable/disable flag, default: disabled)
# When enabled, analytical scan will automatically be set to ~5% of total throughput
enable_analytical_scan=false

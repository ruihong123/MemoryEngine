...
namespace DSMEngine {
    namespace TpccBenchmark {
        ...
        public:
            TpccInitiator(const size_t& thread_count, ClusterConfig* config) : EngineInitiator(thread_count, config) {
                printf("Iitialize the TpccInitiator\n");
            }
            ~TpccInitiator() {}

        protected:
            virtual void RegisterTables(char* const storage_addr, const std::vector<RecordSchema*>& schemas) {
    ...
    InitStockSchema(schemas[STOCK_TABLE_ID]);
        ...
        public:
            static void InitItemSchema(RecordSchema*& schema) {
                ...
                columns.push_back(new ColumnInfo("i_name", ValueType::FIXCHAR, static_cast<size_t>(32)));
                columns.push_back(new ColumnInfo("i_price", ValueType::DOUBLE));
                columns.push_back(new ColumnInfo("i_data", ValueType::FIXCHAR, static_cast<size_t>(64)));
            ...
            static void InitWarehouseSchema(RecordSchema*& schema) {
                ...
                columns.push_back(new ColumnInfo("w_name", ValueType::FIXCHAR, static_cast<size_t>(16)));
                columns.push_back(new ColumnInfo("w_street_1", ValueType::FIXCHAR, static_cast<size_t>(32)));
                columns.push_back(new ColumnInfo("w_street_2", ValueType::FIXCHAR, static_cast<size_t>(32)));
                columns.push_back(new ColumnInfo("w_city", ValueType::FIXCHAR, static_cast<size_t>(32)));
                columns.push_back(new ColumnInfo("w_state", ValueType::FIXCHAR, static_cast<size_t>(2)));
                columns.push_back(new ColumnInfo("w_zip", ValueType::FIXCHAR, static_cast<size_t>(9)));
                columns.push_back(new ColumnInfo("w_tax", ValueType::DOUBLE));
                columns.push_back(new ColumnInfo("w_ytd", ValueType::DOUBLE));
                columns.push_back(new ColumnInfo("padding", ValueType::FIXCHAR, static_cast<size_t>(1024)));
                columns.push_back(new ColumnInfo("meta", ValueType::META));
            ...
            static void InitDistrictSchema(RecordSchema*& schema) {
                ...
                columns.push_back(new ColumnInfo("d_name", ValueType::FIXCHAR, static_cast<size_t>(16)));
                columns.push_back(new ColumnInfo("d_street_1", ValueType::FIXCHAR, static_cast<size_t>(32)));
                columns.push_back(new ColumnInfo("d_street_2", ValueType::FIXCHAR, static_cast<size_t>(32)));
                columns.push_back(new ColumnInfo("d_city", ValueType::FIXCHAR, static_cast<size_t>(32)));
                columns.push_back(new ColumnInfo("d_state", ValueType::FIXCHAR, static_cast<size_t>(2)));
                columns.push_back(new ColumnInfo("d_zip", ValueType::FIXCHAR, static_cast<size_t>(9)));
            ...
            static void InitCustomerSchema(RecordSchema*& schema) {
                ...
                columns.push_back(new ColumnInfo("c_first", ValueType::FIXCHAR, static_cast<size_t>(32)));
                columns.push_back(new ColumnInfo("c_middle", ValueType::FIXCHAR, static_cast<size_t>(2)));
                columns.push_back(new ColumnInfo("c_last", ValueType::FIXCHAR, static_cast<size_t>(32)));
                columns.push_back(new ColumnInfo("c_street_1", ValueType::FIXCHAR, static_cast<size_t>(32)));
                columns.push_back(new ColumnInfo("c_street_2", ValueType::FIXCHAR, static_cast<size_t>(32)));
                columns.push_back(new ColumnInfo("c_city", ValueType::FIXCHAR, static_cast<size_t>(32)));
                columns.push_back(new ColumnInfo("c_state", ValueType::FIXCHAR, static_cast<size_t>(2)));
                columns.push_back(new ColumnInfo("c_zip", ValueType::FIXCHAR, static_cast<size_t>(9)));
                columns.push_back(new ColumnInfo("c_phone", ValueType::FIXCHAR, static_cast<size_t>(32)));
                columns.push_back(new ColumnInfo("c_since", ValueType::INT64));
                columns.push_back(new ColumnInfo("c_credit", ValueType::FIXCHAR, static_cast<size_t>(2)));
                ...
                columns.push_back(new ColumnInfo("c_data", ValueType::FIXCHAR, static_cast<size_t>(500)));
                columns.push_back(new ColumnInfo("meta", ValueType::META));
            ...
            static void InitDistrictNewOrderSchema(RecordSchema*& schema) {
                ...
                columns.push_back(new ColumnInfo("w_id", ValueType::INT));
                columns.push_back(new ColumnInfo("o_id", ValueType::INT));
                columns.push_back(new ColumnInfo("c_data", ValueType::FIXCHAR, static_cast<size_t>(480)));
                columns.push_back(new ColumnInfo("meta", ValueType::META));
            ...
            static void InitOrderLineSchema(RecordSchema*& schema) {
                ...
                columns.push_back(new ColumnInfo("ol_dist_info", ValueType::FIXCHAR, static_cast<size_t>(32)));
                columns.push_back(new ColumnInfo("meta", ValueType::META));
            ...
            static void InitHistorySchema(RecordSchema*& schema) {
                ...
                columns.push_back(new ColumnInfo("h_data", ValueType::FIXCHAR, static_cast<size_t>(32)));
                columns.push_back(new ColumnInfo("meta", ValueType::META));
            ...
            static void InitStockSchema(RecordSchema*& schema) {
                ...
                for (size_t i = 0; i < 10; ++i) {
                    ...
                    columns.push_back(new ColumnInfo(name.c_str(), ValueType::FIXCHAR, static_cast<size_t>(32)));
                }
                ...
                columns.push_back(new ColumnInfo("s_data", ValueType::FIXCHAR, static_cast<size_t>(64)));
                columns.push_back(new ColumnInfo("meta", ValueType::META));

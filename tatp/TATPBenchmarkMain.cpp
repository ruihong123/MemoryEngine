...
int main(int argc, char* argv[]) {
    ...
    if (TWOPHASECOMMIT) {
        auto func = std::bind(
            &TATPExecutor::ProcessQueryThread_2PC_Participant, (void*) &storage_manager, std::placeholders::_1);
    ...
    TATPSource sourcer1(&tatp_scale_params, &redirector1, num_txn / 4, 0, gThreadCount);
    sourcer1.Start();

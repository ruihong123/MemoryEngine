    ...
    namespace TATPBenchmark {
        ...
        public:
            ...
            virtual void PrepareProcedures() {
                registers_[GET_SUBSCRIBER_DATA]    = []() { return new GetSubscriberDataProcedure(); };
                registers_[GET_NEW_DESTINATION]    = []() { return new GetNewDestinationProcedure(); };
                registers_[GET_ACCESS_DATA]        = []() { return new GetAccessDataProcedure(); };
                registers_[UPDATE_SUBSCRIBER_DATA] = []() { return new UpdateSubscriberDataProcedure(); };
                registers_[UPDATE_LOCATION]        = []() { return new UpdateLocationProcedure(); };
                registers_[INSERT_CALL_FORWARDING] = []() { return new InsertCallForwardingProcedure(); };
                registers_[DELETE_CALL_FORWARDING] = []() { return new DeleteCallForwardingProcedure(); };

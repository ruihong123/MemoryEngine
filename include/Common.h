...
#define kInternalPageSize (16384 + 8)

#define kLeafPageSize (16384 + 8)
...
[[maybe_unused]]static GlobalAddress TOPAGE(GlobalAddress addr){
    ...
    size_t bulk_granularity = define::Alloc_Granu;
...
static bool buffer_is_not_all_zero(char* buf, int size) {
